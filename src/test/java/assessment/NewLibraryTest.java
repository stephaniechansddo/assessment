...
public class NewLibraryTest {
	//Defining a name for WebDriver
    private WebDriver webDriver;
    //Finding the HTML File Path
    private static final String BASE_URL = "C:\\Users\\StephChan\\eclipse-workspace\\assessment\\files\\Library.html";
